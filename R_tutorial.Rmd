...
<br>
(However, when I have a problem or my code doesn't work, I usually type "brief description of the problem in R" into google. 99% of the time that takes me to a stackoverflow.com forum where someone has had the same or similar problem with a description of a solution.)  <br>
<br>
